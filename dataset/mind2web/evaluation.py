# TODO 迁移main中的环境准备相关代码
# TODO 用online-mind2web效果会更合理，还有排行榜
...
def process_element_tag(element: str) -> str:
    ...
    for tag in soup.find_all(True):
        ...
        filtered_attrs: dict = {k: tag.attrs[k] for k in tag.attrs if k in SALIENT_ATTRIBUTES}
...
if __name__ == "__main__":
    ...
    print(process_element_tag(text))
